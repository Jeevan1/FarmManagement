    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-12 my-lg-0 my-1">
        ...
        if(isset($_GET['view_products'])){
          ...
          if(!(isset($_GET['profile']) or isset($_GET['order']) or isset($_GET['view_orders']) or isset($_GET['blogs']) or isset($_GET['plans']) or isset($_GET['add_products']) or isset($_GET['view_products']) or isset($_GET['my_order']) or isset($_GET['dashboard']) or isset($_GET['product_id']) or isset($_GET['edit_product'])  )){
            include('./home.php');
          }  
        ?>
  </div>
